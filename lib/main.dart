    ...
    return GestureDetector(
      child: Column(
        ...
        children: [
          ...
          Text(txt, style: TextStyle(fontSize: 16, fontWeight: FontWeight.normal),),
        ],
      ),
      onTap: () {},
    );
                  ...
                  child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(subtxt,style: TextStyle(fontSize: 14,color: Colors.white, fontWeight: FontWeight.normal),)
                        ],
                      )
                  ),
                )
                  ...
                  child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(subtxt,style: TextStyle(fontSize: 16,color: Colors.white, fontWeight: FontWeight.normal),)
                        ],
                      )
                  ),
                )
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: Padding(
              ...
              child:Text('CHEONGSONG', style: TextStyle(fontSize:18, color: Colors.black),),
          ),
          actions: [
            Builder(
      ...
      body: ListView(
        children: <Widget>[
          ...
          Container(
            padding: EdgeInsets.only(top:24,left:24),
            child: Text('즐거운 식생활', style: TextStyle(fontSize: 20),),
          ),
          Container(
          ...
          Container(
            ...
            child: Container(
              ...
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('피시아 (PHYSIA) | 대표 이재협\n사업자등록번호 843-05-01605\n통신판매업 신고번호 2020-서울관악-2686\n피시아는 통신판매중개자로서 통신판매의 당사자가 아니며\n상품 거래정보 및 거래 등에 대해 책임을 지지 않습니다.',style:TextStyle(fontSize: 13, color: Colors.black54, fontWeight: FontWeight.normal)),
                  GestureDetector(
